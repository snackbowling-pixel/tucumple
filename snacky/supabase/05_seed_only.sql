-- =====================================================
-- SEED de los 39 fondos existentes
-- Ejecutar DESPUES de 00_safe_setup.sql
-- =====================================================
...
-- Verificar (deberia devolver 39):
select count(*) as total_fondos from public.backgrounds;
